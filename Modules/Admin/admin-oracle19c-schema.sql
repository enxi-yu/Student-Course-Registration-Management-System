...
BEGIN
    EXECUTE IMMEDIATE q'[
        CREATE TABLE section (
            ...
            CONSTRAINT uq_section_course_semester UNIQUE (course_id, semester)
        )
    ]';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -955 THEN RAISE; END IF;
...
BEGIN
    EXECUTE IMMEDIATE q'[
        CREATE TABLE teaching_class (
            ...
            CONSTRAINT uq_teaching_class_name UNIQUE (section_id, class_name)
        )
    ]';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -955 THEN RAISE; END IF;
...
BEGIN
    EXECUTE IMMEDIATE q'[
        CREATE TABLE batch_class_scope (
            scope_id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
            batch_id NUMBER NOT NULL,
            class_id NUMBER NOT NULL,
            major VARCHAR2(100),
            grade VARCHAR2(20),
            CONSTRAINT fk_bcs_batch_class FOREIGN KEY (batch_id, class_id) REFERENCES batch_class(batch_id, class_id) ON DELETE CASCADE,
