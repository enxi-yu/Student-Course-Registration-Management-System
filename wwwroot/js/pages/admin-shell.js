(function () {
    ...
    window.isAdminTabAllowed = function (tabName) {
        ...
        const allowed = window.ADMIN_LEVEL === 0 ? window.ADMIN_TAB_PERMISSIONS.system : window.ADMIN_TAB_PERMISSIONS.academic;
